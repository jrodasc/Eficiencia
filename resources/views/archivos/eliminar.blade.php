        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h3 class="text-center">¿Está seguro de eliminar el registro?</h3>
                    <br />
                    <form class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="nombre_archivo_delete" autofocus>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="fecha_archivo_delete" autofocus>
                                <small>Min: 2, Max: 32, Solo Texto</small>
                                <p class="errorTitle text-center alert alert-danger hidden"></p>
                            </div>
                        </div>
