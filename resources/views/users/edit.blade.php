            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="row custom-wrapper">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-padding">
                        ...
                        <h2 class="m0 text-uppercase">Editar Usuario</h2>
                    </div>
                    ...
                    {!! Form::model($user, ['method' => 'PATCH','route' => ['users.update', $user->id]]) !!}
                        ...
                        <div class="form-section">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                <div class="form-group">
                                    <p>Contraseña:</p>
                                    {!! Form::password('password', array('placeholder' => 'Contraseña','class' => 'form-control gray-input', 'required')) !!}
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                <div class="form-group">
                                    <p>Confirmar Contraseña:</p>
                                    {!! Form::password('confirm-password', array('placeholder' => 'Confirmar Contraseña','class' => 'form-control gray-input', 'required')) !!}
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group">
                                    <p>Role:</p>
                                    {!! Form::select('roles[]', $roles,$userRole, array('class' => 'form-control gray-input', 'required')) !!}
                                </div>
                            </div>
                        </div>
